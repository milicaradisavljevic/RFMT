#### The second task is e-commerce. The dataset contains 541.909 rows and 8 columns. There were extreme values (outliers) that I had to erase. The dataset looks like this:
